...
Process.prototype.reportExecutionTime = function (aContext) {
	if (!this.context.startTime) {
		...
		this.pushContext();
		this.evaluate(aContext, new List([this.context.continuation()]), true);
	} else {
...
Process.prototype.doGlideToObject = function (secs, name) {
	...
	if (thisObj) {
		...
		if (thatObj) {
			this.doGlide(secs, thatObj.xPosition(), thatObj.yPosition());
		}
	}
};
