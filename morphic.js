...
*/
    ...
    /* 
     * If text file is not xml-encoded, treat
     * it as input data for snap blocks.
     */ 
    function processText(aFile) {
    	var frd = new FileReader(),
    		blob = aFile.slice(0,6),
    		header;
    	while (!target.droppedData) {
    		target = target.parent;
    	}
    	frd.onloadend = function (e) {
    		if (e.target.readyState == FileReader.DONE) {
    				...
    				case "<sprit":
    				case "<media":
    					/* process xml file to create active snap objects */
    					readText(aFile);
    					break;
    				default:
    					/*  
    					 * treat file as passive input data to snap program
    					 * and call import method "droppedData" of IDE_Morph
    					 */
